...
public class Walkthrough extends AppCompatActivity {
    ...
    private String[] title_array = {
            "SELAMAT DATANG", "Ini merupakan biodata milik saya",
            "Semoga aplikasi ini dapat memenuhi kebutuhan\n" +
                    "    tugas UTS saya"
    };
    ...
    private void initComponent() {
        ...
        btn_got_it.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Walkthrough.this, Menu.class);
    ...
    private void bottomProgressDots(int index) {
        ...
        dots[index].setColorFilter(getResources().getColor(R.color.green_sea), PorterDuff.Mode.SRC_IN);
    }
